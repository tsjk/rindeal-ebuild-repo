...
Unix-like computers"
HOMEPAGE="https://www.cfengine.org/ ${GH_HOMEPAGE}"
LICENSE="GPL-3"

SLOT="3"

KEYWORDS="~amd64 ~arm ~arm64"
IUSE_A=( acl examples libvirt mysql postgres +qdbm selinux tokyocabinet vim-syntax xml )
...
RDEPEND_A=( "${CDEPEND_A[@]}" )
PDEPEND_A=(
	"vim-syntax? ( app-vim/cfengine-syntax )"
)
...
src_prepare() {
	...
	sed -e 's|/sbin/ifconfig|/bin/ifconfig|g' \
		-i -- libenv/unix_iface.c || die
