...
if __name__ == '__main__':
  ...
  try:
    ...
    runner = FirefoxRunner(profile=profile,
                           ...
                           cmdargs=cmdargs,
                           env=env)
    runner.start(debug_args=debug_args, interactive=False)
    # index.html should close itself, but rather play it safe and force close after a few minutes
    runner.wait(15*60)
    runner.stop()
    httpd.stop()
  finally:
