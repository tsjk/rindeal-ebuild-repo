...
if [[ "${PV}" == *9999* ]] ; then
	EGIT_REPO_URI="https://github.com/videolan/${PN}.git"
...
IUSE_A=(
	a52 aalib alsa altivec +audioqueue +avcodec
...
src_configure() {
	...
	local econf_args=(
		...
		$(use_enable httpd) # built-in HTTP server
		...
		$(use_enable $(usex qt4 qt4 qt5) qt)
