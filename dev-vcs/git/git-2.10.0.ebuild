...
inherit toolchain-funcs eutils elisp-common perl-module bash-completion-r1 python-single-r1 systemd

DESCRIPTION="stupid content tracker: distributed VCS designed for speed and efficiency"
HOMEPAGE="http://www.git-scm.com/"
LICENSE="GPL-2"

SRC_URI_BASE="mirror://kernel/software/scm/git"
SRC_URI="
    ${SRC_URI_BASE}/${P}.tar.xz
	${SRC_URI_BASE}/${PN}-manpages-${PV}.tar.xz
	doc? ( ${SRC_URI_BASE}/${PN}-htmldocs-${PV}.tar.xz )"
SLOT="0"
